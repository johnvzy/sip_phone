...
public class ScreenAV extends BaseScreen{
	...
	public static boolean makeCall(String remoteUri, NgnMediaType mediaType){
		...
		new addSipCallRecord().execute(ScreenHome.LastRegBedId,remoteUri);
	...
	//Todo:置換url
	private static class addSipCallRecord  extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... urls) {
			try {
				HttpGet httpget = new HttpGet("http://122.117.112.216:5388/addSipCallRecord.aspx?BedId=" + urls[0] +"&CallId="+urls[1]);
